...
public class FilterColorsAdapter extends RecyclerView.Adapter<FilterColorsAdapter.ViewHolder> {

    Context mContext;
    ArrayList<FilterColorsDetails> mList;
...
// you provide access to all the views for a data item in a view holder
    ...
    public FilterColorsAdapter(Context context, ArrayList<FilterColorsDetails> mList) {
        super();
...
//        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.category_1_item_layout, parent, false);
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.filter_colors_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder1, final int position) {
        ...
        holder1.lblColor.setText(mList.get(position).getColorName());

        holder1.colorLayout.setBackgroundColor(Color.parseColor(mList.get(position).getColorCode()));
