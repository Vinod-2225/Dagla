...
public class ProductsFromHomeBannerFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getArguments().getString("brand_id")!= null && !getArguments().getString("brand_id").equals("vpM1hJ6qjWc=")) {
            //
        ...
        if (getArguments().getString("cat_id")!= null && !getArguments().getString("cat_id").equals("vpM1hJ6qjWc=")) {
            //
        ...
        //
        if (getArguments().getString("sub_cat_id")!= null && !getArguments().getString("sub_cat_id").equals("vpM1hJ6qjWc=")) {
            //
        ...
        if (getArguments().getString("home_banner_name")!= null) {
            String title2 = getArguments().getString("home_banner_name");
            ((MainActivity) getActivity()).setHeaders(title2,true,false,true,true,true ,"3", false);
        }else {
//            ((MainActivity) getActivity()).setHeaders(getResources().getString(R.string.essentials),false,false,false,true,true);
            ((MainActivity) getActivity()).setHeaders(title,true,false,true,true,true ,"3", false);
        }
