...
//                Bundle b = getArguments().getExtras();
                //
                String s = getArguments().getString("obj");
...
//                Log.v("ProductID*****",objMain.getString("product_id"));
...
//                                }
                            ...
                            try {
                                segmentation.put("Product Id", ""+objMain.getString("product_id"));
                            } catch (JSONException e) {
                                e.printStackTrace();
                            }
...
//                            }
                            ...
                            adapterImages = new ImagesAdapter(getActivity(), arrImages, ProductDescriptionFragment.this);
...
//                                rvRelatedItems.setNestedScrollingEnabled(false);
                            ...
                            for (int j = 0; j < arr3.length(); j++) {
                                ...
                                colorsProductIdArrList.add(arr3.getJSONObject(j).getString("product_id"));
...
//                                    productColorsAdapter.Selected(position);
                            ...
                            relatedItemsAdapter = new RelatedItemsAdapter(getActivity(), arrayList1, arrayList2, arrayList3, arrayList4,ProductDescriptionFragment.this,"Category");
...
//                                arrItems.add(arr.getJSONObject(i).getString("product_id").toString());
                        ...
                        if (!variationProductId.equalsIgnoreCase("")) {
                            ...
                            try {
                                ...
                                String pro_id = objMain.getString("product_id");
...
//        HashMap<String, String> segmentation = new HashMap<String, String>();
//
//        segmentation.put("Product Name", ""+getArguments().getString("title"));
//        segmentation.put("app_version", ""+versionCode);
//
//        Countly.sharedInstance().recordEvent("Added To Cart", segmentation, 1);
